...
| `output/repository_integrity/` | repository audit | generated audit | canonical audit | `verify_repository_integrity.py` | No | integrity report and summary | repository maintainers | Not a scientific result. |
