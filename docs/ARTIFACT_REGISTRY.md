...
Detailed per-file SHA-256 values are stored in
`docs/repository_audit/repository_inventory_before.csv` and
`docs/repository_audit/critical_artifact_hashes_before.csv`. This document lists the canonical artifact
groups used by the research pipeline.
...
| Sentiment V2 model | `output/rm2_sentiment/model_v2/selected_model_development_frozen.joblib` | RM2 sentiment | Frozen development training | Locked-test evaluation and final inference | FROZEN_RESEARCH_ARTIFACT | Yes | `477bfe11ebc3463eeff5a5fb8359f86022d719c8bea49dfdad0460fa0c5e2ccc` | No | Do not retrain during cleanup. |
| Final locked test | `output/rm2_sentiment/human_validation_v2/locked_test_v2_observational_final.csv` | RM2 sentiment | Locked-test freeze | One-time evaluation | DEVELOPMENT_PROVENANCE | Yes | `663a69964d57ccd9dc4e05ec091a30fb6b1f3e12d0ecb271ba56ba70603bbfc8` | No | 300 observational rows, 0 synthetic/injected. |
| Evaluation lock | `output/rm2_sentiment/model_v2/final_locked_test_evaluation_lock.json` | RM2 sentiment | One-time evaluator | Integrity verifier | FROZEN_RESEARCH_ARTIFACT | Yes | `ea08186fc1bcb05507abea57991a06a5c918fffd66c3074a1849e6e9a96b81c2` | No | Records `FINAL_LOCKED_TEST_EVALUATED_ONCE`. |
| Final Sentiment V2 predictions | `output/rm2_sentiment/final_v2/comment_sentiment_v2_observational.csv` | RM2 sentiment | Final inference script | RM2 reports and Gephi attributes | FROZEN_RESEARCH_ARTIFACT | Yes | `64b4fdacb9c623798035b5ed024e050d7e73de2a2260a7a8fcede5a4032b20d6` | No | 33063 observational rows. |
| Final Sentiment V2 manifest | `output/rm2_sentiment/final_v2/FINAL_SENTIMENT_ANALYSIS_MANIFEST.json` | RM2 sentiment | Final inference script | Integrity verifier | FROZEN_RESEARCH_ARTIFACT | Yes | `beed4dc304ca71ad8fb6069ec34b71103844f7b5806c4814cf14d592b7bfe040` | No | Final status `FINAL_MODEL_VALIDATED`. |
...
|---|---|---|---|
| Sentiment V1 outputs | `output/rm2_sentiment/tables/` | LEGACY_REQUIRED_FOR_REPRODUCIBILITY | Kept for V1/V2 transition and historical comparison. |
| Sentiment V1 Gephi | `output/rm2_sentiment/gephi/` | LEGACY_REQUIRED_FOR_REPRODUCIBILITY | Not overwritten by V2 final Gephi exports. |
| Exploratory wordcloud | `output/rm2_sentiment/visualisasi_exploratory/` | EXPLORATORY_OUTPUT | Presentation context only, not validation evidence. |
