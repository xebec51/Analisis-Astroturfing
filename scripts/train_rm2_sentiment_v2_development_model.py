...
V2_VALIDATED_PATH = ROOT / "output/rm2_sentiment/validation/human_v2/sentiment_human_annotation_v2_validated.csv"
V2_ADJUDICATION_FINAL_PATH = ROOT / "output/rm2_sentiment/validation/human_v2/sentiment_v2_adjudication_template_final.csv"
V2_LOCKED_MANIFEST_PATH = ROOT / "output/rm2_sentiment/validation/human_v2/locked_test_v2_manifest.csv"
V2_SYNTHETIC_AUDIT_PATH = ROOT / "output/rm2_sentiment/validation/human_v2/sentiment_v2_synthetic_id_audit.csv"

OUT_DIR = ROOT / "output/rm2_sentiment/model/frozen"
