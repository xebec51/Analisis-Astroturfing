...
SENTIMENT_MODEL_PATH = ROOT / "output/rm2_sentiment/model_v2/selected_model_development_frozen.joblib"
SENTIMENT_MANIFEST_PATH = ROOT / "output/rm2_sentiment/model_v2/development_model_manifest.json"
...
FINAL_LOCKED_TEST_BLOCKED = "BLOCKED_WAITING_FOR_8_HUMAN_ANNOTATED_REPLACEMENTS"
...
def integrity_report(
    ...
    rows = [
        ...
        ("comment_sentiment_full_inference_not_run", True, hashes_before["comment_sentiment"] == hashes_after["comment_sentiment"], hashes_before["comment_sentiment"] == hashes_after["comment_sentiment"], ""),
        ("locked_test_not_evaluated", FINAL_LOCKED_TEST_BLOCKED, model_manifest.get("final_locked_test_evaluation_status", ""), model_manifest.get("final_locked_test_evaluation_status", "") == FINAL_LOCKED_TEST_BLOCKED, ""),
    ]
    report = pd.DataFrame(
