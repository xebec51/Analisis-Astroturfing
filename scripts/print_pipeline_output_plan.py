...
PIPELINES = [
    ...
    },
    {
        ...
        "entrypoint": RM1_NOTEBOOK_PATH,
        "inputs": ["output/gephi/", "output/rm2_sentiment/final/comment_sentiment_v2_observational.csv"],
    ...
    },
    {
        ...
        "inputs": ["RM1 outputs"],
        "outputs": ["selected legacy reference files and PNGs only"],
        "artifacts": ["sentiment_heuristic_reference_guideline.md", "sentiment_model_selection.json", "legacy visualisasi/*.png"],
        "overwrite": "archived; notebook execution is disabled so trimmed CSVs are not regenerated",
        "status": "LEGACY_V1_ARCHIVED",
    },
    {
        "pipeline": "RM2 Sentiment final reporting",
        "entrypoint": RM2_SENTIMENT_NOTEBOOK_PATH,
        "inputs": [RM2_SENTIMENT_FINAL_DIR, RM2_SENTIMENT_MODEL_DIR],
        "outputs": [RM2_SENTIMENT_FINAL_DIR],
        "artifacts": ["final tables", "presentation summary", "final visualisasi/*.png"],
        "overwrite": "visual/report-producing only; does not train, evaluate locked test, or infer",
        "status": "CANONICAL_RM2_SENTIMENT_FINAL_REPORTING",
    },
    {
        "pipeline": "RM2 Sentiment model/final artifacts",
        "entrypoint": "scripts/train/freeze/evaluate/apply Sentiment V2 scripts",
        "inputs": [RM2_SENTIMENT_HUMAN_VALIDATION_V2_DIR, RM2_SENTIMENT_MODEL_DIR],
        "outputs": [RM2_SENTIMENT_FINAL_DIR],
        "artifacts": ["final_locked_test_*", "comment_sentiment_v2_observational.csv"],
        "overwrite": "frozen or already generated; do not rerun unless explicitly reproducing final artifacts",
