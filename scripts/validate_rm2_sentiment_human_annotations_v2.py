...
DEFAULT_DIR = ROOT / "output/rm2_sentiment/human_validation_v2"
...
def main() -> None:
    ...
    parser.add_argument("--human-dir", default=str(DEFAULT_DIR), help="Path to human_validation_v2 directory.")
    parser.add_argument(
        "--output",
