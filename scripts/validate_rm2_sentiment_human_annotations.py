...
def main() -> None:
    ...
    parser.add_argument(
        "annotation_csv",
        nargs="?",
        default="output/rm2_sentiment/human_validation/sentiment_human_validation_template.csv",
        help="Path to completed human annotation CSV.",
    )
    parser.add_argument(
        "--output",
        default="output/rm2_sentiment/human_validation/human_validation_metrics.csv",
