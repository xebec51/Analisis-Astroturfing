...
LEGACY_COMMENT_SENTIMENT = ROOT / "output/rm2_sentiment/legacy/v1/tables/comment_sentiment.csv"
...
def legacy_comparison(obs: pd.DataFrame, hcc_summary_v2: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    old_goals_path = ROOT / "output/rm2_sentiment/legacy/v1/tables/hcc_sentiment_goals_summary.csv"
